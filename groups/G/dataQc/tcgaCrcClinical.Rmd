...
rmdUrl <- getPermlink(crcscRepo, "groups/G/dataQc/tcgaCrcClinical.Rmd")
...
clinOut <- data.frame(id=clin$bcr_patient_barcode,
                      ...
                      osMo=ifelse(clin$vital_status=="DECEASED",
                                  as.numeric(clin$days_to_death[clin$vital_status == "DECEASED"])*12/365,
                                  as.numeric(clin$days_to_last_known_alive[clin$vital_status != "DECEASED"])*12/365),
