...
This wiki summarizes the clinical data for patients which have RNA-seq data available and QCed in this project. The resulting tab delimited text file [`r clinFile@properties$name`](#!Synapse:`r clinFile@properties$id`) contains clinical information on these `r nrow(clinOut)` samples.
...
```
####! T Stage
```{r tstage, echo=FALSE, results='asis'}
synTable(table(clinOut$tStage))
```
####! N Stage
```{r nstage, echo=FALSE, results='asis'}
synTable(table(clinOut$nStage))
```
####! M Stage
```{r mstage, echo=FALSE, results='asis'}
